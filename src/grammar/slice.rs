...
impl Type for TypeAlias {
    ...
    fn supported_encodings(&self) -> SupportedEncodings {
        // Type-aliases are transparent and are removed in the type-patching phase.
        // Since this occurs before computing the supported encodings, this should never be reached.
        panic!("tried to retrieve supported encodings for a type-alias")
    }
}
...
impl Type for Dictionary {
    ...
    fn supported_encodings(&self) -> SupportedEncodings {
        ...
        encodings.intersect(self.value_type.supported_encodings());
        encodings
    }
}
