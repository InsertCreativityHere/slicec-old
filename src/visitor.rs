...
/// For example, calling `visit_with` on an interface containing a single operation would invoke:
/// - visit_interface
///     - visit_operation
...
pub trait Visitor {
    ...
    ///
    /// This shouldn't be called by users. To visit an module, use `[Module::visit_with]`.
